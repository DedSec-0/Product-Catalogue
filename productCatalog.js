//add event handlers here
    document.getElementById("inputID_Button").addEventListener('click',function(){
        processSearch(document.getElementById('inputID').value);
    });
    document.getElementById("inputType_Button").addEventListener('click',function(){
        processSearchByType(document.getElementById('inputType').value);
    });
    document.getElementById("inputPrice_Button").addEventListener('click',function(){
